#%%https://github.com/ffreemt/phrase-tokenizer
...
try:
    ...
    from IPython.display import \
        display  # pylint: disable=import-error  # for notebook
...
sentence="Philip Kitcher and Wesley Salmon have suggested that there are two possible alternatives among philosophical theories of explanation."
plot_tree(sentence)
